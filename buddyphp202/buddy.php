...
if ($xoopsUser) {
    ...
    echo "<LINK REL=\"StyleSheet\" HREF=\"../../themes/$currenttheme/style.css\" TYPE=\"text/css\">\n";
} else {
    echo "<html>\n<head>\n";
...
telwin = window.open(\"buddy.php?task=buddyread&msg_id=$msgs[msg_id]\", \"$priv_msg[msg_time]\", \"width=450,height=370,toolbar=no,location=no,menubar=no,scrollbars=yes,resizeable=no,status=no\");\n
    ...
    echo '<title>' . $xoopsConfig['sitename'] . " - $ModName</title><LINK REL=\"StyleSheet\" HREF=\"../../themes/$currenttheme/style.css\" TYPE=\"text/css\">
...
function buddyread($msg_id)
{
    ...
    echo '<title>' . _INCOMINGFROM . " $from_user !</title><LINK REL=\"StyleSheet\" HREF=\"../../themes/$currenttheme/style.css\" TYPE=\"text/css\">\n";
